...
4. **Agent Documentation in `docs-ref/*`**:
   - All documentation, plans (`{task-slug}.md`), design specifications (`DESIGN.md`), and architectural notes generated by the AI are strictly saved inside `docs-ref/*` to keep the project root clean.
