  ...
  faq: {
    ...
    items: [
      ...
      },
      {
        ...
        answer:
          "Run npx @camilyos/ag-kit init in your project (or install the CLI globally). It downloads the toolkit into .agents and writes a managed-file manifest.",
      },
      {
        value: "update",
  ...
  faq: {
    ...
    items: [
      ...
      },
      {
        ...
        answer:
          "Chạy npx @camilyos/ag-kit init trong dự án (hoặc cài CLI toàn cục). Toolkit được tải vào .agents và ghi managed-file manifest.",
      },
      {
        value: "update",
  ...
  faq: {
    ...
    items: [
      ...
      },
      {
        ...
        question: "如何安装？",
        answer:
          "在项目中运行 npx @camilyos/ag-kit init（或全局安装 CLI）。它会把工具包下载到 .agents 并写入托管文件清单。",
      },
      {
        value: "update",
  ...
  faq: {
    ...
    items: [
      ...
      },
      {
        ...
        question: "インストール方法は？",
        answer:
          "プロジェクトで npx @camilyos/ag-kit init を実行します（CLI のグローバルインストールも可）。ツールキットが .agents にダウンロードされ、管理ファイルのマニフェストが書き込まれます。",
      },
      {
        value: "update",
