                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-8">
                    ...
                    <div>
                        ...
                        <ul className="space-y-3 text-sm">
                            ...
                            <li>
                                <a href="https://github.com/dev-richardnguyen/ag-kit" target="_blank" rel="noopener noreferrer" className="text-muted-foreground hover:text-foreground transition-colors">
                                    {f.examples}
                                </a>
                            </li>
                            <li>
                    ...
                    <div>
                        ...
                        <ul className="space-y-3 text-sm">
                            ...
                            <li>
                                <a href="https://github.com/dev-richardnguyen/ag-kit/issues" target="_blank" rel="noopener noreferrer" className="text-muted-foreground hover:text-foreground transition-colors">
                                    {f.issues}
                                </a>
                            </li>
                            <li>
                                <a href="https://github.com/dev-richardnguyen/ag-kit/discussions" target="_blank" rel="noopener noreferrer" className="text-muted-foreground hover:text-foreground transition-colors">
                                    {f.discussions}
                                </a>
                            </li>
                            <li>
                                <a href="https://github.com/dev-richardnguyen/ag-kit/blob/main/CONTRIBUTING.md" target="_blank" rel="noopener noreferrer" className="text-muted-foreground hover:text-foreground transition-colors">
                                    {f.contributing}
                                </a>
                            </li>
                        </ul>
                    ...
                    <div>
                        ...
                        <ul className="space-y-3 text-sm">
                            <li>
                                <a href="https://github.com/dev-richardnguyen/ag-kit/blob/main/LICENSE" target="_blank" rel="noopener noreferrer" className="text-muted-foreground hover:text-foreground transition-colors">
                                    {f.license}
                                </a>
                            </li>
                            <li>
